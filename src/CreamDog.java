...
public class CreamDog extends Dogs {

    public CreamDog(int x, int y, CatBoard catBoard) {
        super(x, y, catBoard, 10);
    }

    public CreamDog(int x, int y, CatBoard2 catBoard2) {
        super(x, y, catBoard2, 7);
    }

    public CreamDog(int x, int y, CatBoard3 catBoard3) {
        super(x, y, catBoard3, 9);
    }
    ...
    public void loadImages() {
        try {
            dog = ImageIO.read(this.getClass().getResource("/images/cream_dog.png"));
        } catch (IOException e) {
