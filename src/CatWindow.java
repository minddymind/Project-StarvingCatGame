...
public class CatWindow extends JFrame {

    public CatWindow() {
        setTitle("Starving Cat Game : Savanna Map");
        ...
        MapData mapA = getMapFromResource("/maps/mapsavanna.txt");
        adjustMap(mapA);

        CatBoard cb = new CatBoard(scBoard, mapA, this);
        addKeyListener(cb.cat);
