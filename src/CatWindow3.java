...
public class CatWindow3 extends JFrame {

    public CatWindow3() {
        setTitle("Starving Cat Game : Tundra Map");
        ...
        MapData mapA = getMapFromResource("/maps/maptundra.txt");
        adjustMap(mapA);

        CatBoard3 cb3 = new CatBoard3(scBoard, mapA, this);
        addKeyListener(cb3.cat);
