...
public class BrownDog extends Dogs {

    public BrownDog(int x, int y, CatBoard2 catBoard2) {
        super(x, y, catBoard2, 6);
    }

    public BrownDog(int x, int y, CatBoard catBoard) {
        super(x, y, catBoard, 6);
    }

    public BrownDog(int x, int y, CatBoard3 catBoard3) {
    ...
    public MoveType getMove2() {
        ...
        if (isDead) {
            return baseReturner.getMove(logicalPosition.x, logicalPosition.y, baseBoard2.dogBase.x,
                    baseBoard2.dogBase.y);
        } else {
    ...
    public MoveType getMove3() {
        ...
        if (isDead) {
            return baseReturner.getMove(logicalPosition.x, logicalPosition.y, baseBoard3.dogBase.x,
                    baseBoard3.dogBase.y);
        } else {
    ...
    public void loadImages() {
        try {
            dog = ImageIO.read(this.getClass().getResource("/images/brown_dog.png"));
        } catch (IOException e) {
        }
